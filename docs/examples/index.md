...
if (client.CreateClient("ChronoScan.W2012WEBCLOUD", "admin", "12345") == 1)
{
...
if (job != null)
{
	...
	*/
	Console.WriteLine("\t\t\tAdding sample FILE 1 to the Batch----------------------------------------------->");
	Batch.AddFileToBatch("\\\\nasdf\\digitalfile\\PROYECTOS\\Imagenes\\Facturas varias\\LOEZ\\2018-3421(0)(0).pdf");
	Console.WriteLine("\t\t\tAdding sample FILE 2 to the Batch----------------------------------------------->");
	Batch.AddFileToBatch("\\\\nasdf\\digitalfile\\PROYECTOS\\Imagenes\\Facturas varias\\LOEZ\\2019-3960(0)(0).pdf");
